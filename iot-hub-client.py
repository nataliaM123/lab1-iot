...
def get_sensor_blood_sugar():
    blood_sugar = AUX_BASE_BLOOD_SUGAR + (random.random() * random.random() * 10)
...
def iothub_client_telemetry_sample_run():
	...
	#IT WILL RUN FOREVER UNLESS YOU STOP IT
	    ...
	    blood_sugar_measure = get_sensor_blood_sugar()
		...
		#NEW METRIC COLLECTION SHOULD ADD CODE HERE
            ...
            sensor_data['blood_sugar'] = blood_sugar_measure
